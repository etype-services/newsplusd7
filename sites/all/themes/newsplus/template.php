...
function newsplus_preprocess_html(&$variables) {
  ...
  */
  ...
  if (theme_get_setting('google_map_js', 'newsplus')) {
    ...
    drupal_add_js('https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyDHYWYdyYlbOVXbvzv1BGom_4v5HlOxvN0',array('type' => 'external', 'scope' => 'header', 'group' => 'JS_THEME'));
